...
@REM     --train_data_dir="D:\AICGCode\checkpoint_train\dataset\dataset_train_tiny_symbol" ^
@REM     --output_dir="D:/AIGC/model/slot_checkpoints" ^
@REM     --logging_dir="D:/AIGC/model/slot_checkpoints" ^
@REM     --sample_prompts="D:/AIGC/model/slot_checkpoints/data/sample_prompts_tiny_symbol.json" --sample_sampler="dpm_2" ^
@REM     --output_name="slot_checkpoints" ^
@REM     --cache_latents --cache_latents_to_disk --cache_text_encoder_outputs ^
@REM     --optimizer_type="Lion8bit" --max_data_loader_n_workers="0" --gradient_checkpointing --xformers ^
...
@REM     --max_train_steps="22400" --sample_every_n_steps="200" --save_every_n_steps="4000000" ^
@REM     --resolution="1024,1024" ^
@REM     --learning_rate="1e-5" --min_timestep=100 --log_with="wandb"
...
accelerate launch --num_processes=1 --num_machines=1 --mixed_precision=bf16 --dynamo_backend=no --num_cpu_threads_per_process=1  "./sdxl_train.py" ^
    ...
    --train_data_dir="D:\AICGCode\checkpoint_train\dataset\dataset_train_v1_onlySymbol_ruleBaseCaption" ^
    --output_dir="D:/AIGC/model/slot_checkpoints_symbol2" ^
    --logging_dir="D:/AIGC/model/slot_checkpoints_symbol2" ^
    ...
    --mixed_precision="bf16" --save_precision="bf16" --no_half_va --full_bf16 --caption_extension=".txt" --cache_latents ^
    --train_batch_size=2 --accumulation_n_steps=4 ^
    --max_train_steps="504000" --sample_every_n_steps="504" --save_every_n_steps="5040"^
    --resolution="1024,1024" ^
    --learning_rate="1e-5" --log_with="wandb" 
...
@REM     --output_name="slot_checkpoints" ^
@REM     --cache_latents --cache_latents_to_disk --cache_text_encoder_outputs ^
@REM     --optimizer_type="Lion8bit" --max_data_loader_n_workers="1" --persistent_data_loader_workers --gradient_checkpointing --xformers ^
@REM     --log_prefix=slot_checkpoints ^
@REM     --save_model_as=safetensors ^
@REM     --mixed_precision="bf16" --save_precision="bf16"  --no_half_vae --full_bf16 --caption_extension=".txt" --cache_latents ^
@REM     --train_batch_size=2 --accumulation_n_steps=4 ^
...
@REM     --resolution="1024,1024" ^
@REM     --learning_rate="1e-5" --log_with="wandb" ^
@REM     --pretrained_model_name_or_path="D:/AIGC/model/slot_checkpoints/slot_checkpoints-step00021930.safetensors" ^
@REM     --global_step=21931
